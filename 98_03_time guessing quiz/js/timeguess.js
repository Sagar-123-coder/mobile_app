...
stop.addEventListener("click",
  function() {
    // タイマーを"停止中"状態とする
    setButtonStateStopped();               // ← call the function
...
function setButtonStateInitial() {
  ...
  timer.classList.add("timer_appear");              // 時間をゆっくり表示 (ドット不要)
  start.classList.remove("js-inactive");            // Start 有効
  stop.classList.add("js-inactive");                // Stop 無効
  reset.classList.add("js-inactive");               // Reset 無効
...
function setButtonStateRunning() {
  ...
  start.classList.add("js-inactive");            // Start 非活性
  stop.classList.remove("js-inactive");          // Stop 活性
  reset.classList.add("js-inactive");            // Reset 非活性
...
function setButtonStateStopped() {
  timer.classList.remove("timer-fontColor_hidden"); // 時間を見えるようにする
  timer.classList.add("timer_appear");              // ドットは不要
  start.classList.remove("js-inactive");            // Start 有効
  stop.classList.add("js-inactive");                // Stop 無効
  reset.classList.remove("js-inactive");            // Reset 有効
  start.classList.remove("js-unclickable");
  stop.classList.add("js-unclickable");
